        ...
        <MDBCard style={{marginBottom: "6px"}}>
            <MDBCardBody>
                <div style={{display: "flex", alignItems: "center"}}>
                    ...
                    <p style={{marginLeft: "10px", minWidth: "20%", marginBottom: "0px"}}>Student 1</p>
                    <MDBIcon size="sm" style={{marginLeft: "15px"}} icon="pen" />
                </div>
                <div style={{display: "flex", alignItems: "center", marginTop: "30px"}}>
                    <input type="color" value="#4285F4" style={{maxWidth: "30px", height: "30px", padding: "0px", marginBottom: "0px", border: "none"}} />
                    <p style={{marginLeft: "10px", marginBottom: "0px"}}>Color</p>
                    <div style={{display: "flex", justifyContent: "flex-end", alignItems: "center", width: "100%"}}>
                        <a href="#" style={{marginBottom: "0px", marginRight: "10px"}}>View activites</a>
